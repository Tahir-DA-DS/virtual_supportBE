...
import { validateRequest, sessionValidation } from '../middlewares/validation.middleware';
import {
  createNewSession,
  getSession,
...
router.post('/', 
  ...
  validateRequest(sessionValidation.create),
  createNewSession
);
...
router.put('/:id', 
  authenticate,
  validateRequest(sessionValidation.update),
  updateSessionDetails
);
 ...
 *         description: Server error
 */
router.post('/:id/cancel', authenticate, cancelSessionById);
 ...
 *         description: Server error
 */
router.get('/my/upcoming', authenticate, getMyUpcomingSessions);
 ...
 *         description: Server error
 */
router.get('/my/stats', authenticate, getMySessionStats);
